 ...
 * The monthly analysis features, including this month-over-month comparison chart, 
 * have been removed to streamline the application for single-run analysis.
 */
export const CurrentVsPreviousMonthComparisonChart: React.FC = () => {
  return (
    <div className="p-4 my-6 bg-yellow-50 border border-yellow-300 rounded-lg">
      ...
      <p className="text-yellow-700 text-sm">
        The CurrentVsPreviousMonthComparisonChart component is no longer in use.
      </p>
    </div>
  );
};
